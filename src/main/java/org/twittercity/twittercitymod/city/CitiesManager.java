...
public class CitiesManager {
    ...
    public int startBuilding(List<Tweet> tweets, City currentConstructingCity) {
        ...
        return Buildings.makeInsideCity(twitterWorld, currentConstructingCity, tweets);
    }
    ...
    private CitySettings getNewCitySettings() {
        ...
        if (cityId >= 0) {
            ...
            cityStateId = 1;
            newCityConstructionInfo.setCitiesSquareNorthWestCorner(startingPos);
        }
...
//				edgeLength, pathExtends, groundBlock, pathBlock, true, true);
        ...
        //constrWorldData.setCurrentConstructingCityId(cityId);
