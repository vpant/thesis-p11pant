...
public class WorldTypeTwitterCity extends WorldType {
	...
	public BiomeProvider getBiomeProvider(World world) {
		return new BiomeProviderTwitterCity();
	}
	 ...
	 * 
	 * @see
	 * net.minecraft.world.WorldType#getChunkGenerator(net.minecraft.world.World,
	 * java.lang.String)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see net.minecraft.world.WorldType#getMinimumSpawnHeight(net.minecraft.world.
	 * World)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * net.minecraft.world.WorldType#handleSlimeSpawnReduction(java.util.Random,
