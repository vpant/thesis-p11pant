...
public abstract class TCTweetPopup extends BasicScreen {
	
	private static final ResourceLocation TEXTURE = new ResourceLocation(Reference.MOD_ID, "textures/gui/window.png");
	
	public static final int WIDTH = 256, HEIGHT = 129;

	public TCTweetPopup(BasicScreen bg) {
		super(bg);
	}
