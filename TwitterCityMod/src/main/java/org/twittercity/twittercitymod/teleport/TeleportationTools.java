...
public class TeleportationTools {
	public static void performTeleport(EntityPlayer player, int dimension, BlockPos dest,
	...
	/**
	 * Get a world for a dimension, possibly loading it from the configuration
	 * manager.
	 */
	...
	/**
	 * Teleport an entity and return the new entity (as teleporting to other
	 * dimensions causes entities to be killed and recreated)
	 */
