...
protected  World world;
    ...
    protected Biome biome = TwitterCityBiomes.twitter_city;
    protected IBlockState baseBlock = Blocks.BED.getDefaultState();
	...
	public ChunkGeneratorTwitterCity(World worldIn) {
		world = worldIn;
        ...
        MapGenVillage.VILLAGE_SPAWN_BIOMES.add(TwitterCityBiomes.twitter_city);
