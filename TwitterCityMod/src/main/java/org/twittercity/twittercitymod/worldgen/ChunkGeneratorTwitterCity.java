...
public class ChunkGeneratorTwitterCity implements IChunkGenerator {
	...
	private IBlockState oceanBlock = Blocks.GRASS.getDefaultState(); // No oceans
	 ...
	 * https://minecraft.gamepedia.com/Customized#Customization
	 */
	...
	public ChunkGeneratorTwitterCity(World worldIn, long seed, boolean mapFeaturesEnabledIn, String generatorOptions) {
		...
		oceanMonumentGenerator = (StructureOceanMonument) TerrainGen.getModdedMapGen(oceanMonumentGenerator,
	...
	private void generateHeightmap(int p_185978_1_, int p_185978_2_, int p_185978_3_) {
		this.depthRegion = this.depthNoise.generateNoiseOctaves(this.depthRegion, p_185978_1_, p_185978_3_, 5, 5,
				(double) this.depthNoiseScaleX, (double) this.depthNoiseScaleZ,
				(double) this.depthNoiseScaleExponent);
		...
		this.mainNoiseRegion = this.mainPerlinNoise.generateNoiseOctaves(this.mainNoiseRegion, p_185978_1_, p_185978_2_,
				p_185978_3_, 5, 33, 5, (double) (f / this.mainNoiseScaleX),
				(double) (f1 / this.mainNoiseScaleY), (double) (f / this.mainNoiseScaleZ));
			...
			for (int l = 0; l < 5; ++l) {
				...
				for (int j1 = -2; j1 <= 2; ++j1) {
					for (int k1 = -2; k1 <= 2; ++k1) {
						...
						float f5 = this.biomeDepthOffSet
								+ biome1.getBaseHeight() * this.biomeDepthWeight;
						float f6 = this.biomeScaleOffset
								+ biome1.getHeightVariation() * this.biomeScaleWeight;
	...
	public void populate(int x, int z) {
		...
		if (biome != Biomes.DESERT && biome != Biomes.DESERT_HILLS && this.useWaterLakes && !flag
				&& this.rand.nextInt(this.waterLakeChance) == 0)
	...
	public List<Biome.SpawnListEntry> getPossibleCreatures(EnumCreatureType creatureType, BlockPos pos) {
		...
		if (this.mapFeaturesEnabled) {
			...
			if (creatureType == EnumCreatureType.MONSTER && this.useMonuments
