...
public class TCBlockRotatedPillar extends TCBlock {
	public static final PropertyEnum<EnumFacing.Axis> AXIS = PropertyEnum.<EnumFacing.Axis>create("axis", EnumFacing.Axis.class);

    protected TCBlockRotatedPillar(Material materialIn)
    {
        super(materialIn, materialIn.getMaterialMapColor());
    }

    protected TCBlockRotatedPillar(Material materialIn, MapColor color)
    {
